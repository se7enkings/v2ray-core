...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/se7enkings/quic-go/internalpackage
...
cp -r $GOPATH/src/github.com/se7enkings/quic-go/internal/* $TEMP_DIR/src/github.com/se7enkings/quic-go/internalpackage
